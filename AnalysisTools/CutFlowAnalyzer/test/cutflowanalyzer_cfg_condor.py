...
process.load("AnalysisDataFormats.MuJetAnalysis.filelists.darksusy_mD0550_ctauExp_5_cff");
# process.load("AnalysisDataFormats.MuJetAnalysis.filelists.darksusy_mD0250_ctauExp_02_cff");
...
# process.load("AnalysisDataFormats.MuJetAnalysis.filelists.darksusy_cascade_cff");
...
# process.TFileService = cms.Service("TFileService", fileName = cms.string("darksusy_cascade_test.root") )
process.TFileService = cms.Service("TFileService", fileName = cms.string("darksusy_mD0550_ctauExp_5_%03d.root" % PROCESS) )




# process.TFileService = cms.Service("TFileService", fileName = cms.string("darksusy_mD0250_ctauExp_02.root") )
